<<<<<<< HEAD
<h1 align="center">SURBANA TEST PROJECT</h1>
<p align="center">
...
>>>>>>> 2aba719 (init project, add docker-compose, connect posgresql database)
```bash
# development
$ npm run start
...
>>>>>>> 3be75e1 (init project, add docker-compose, connect posgresql database)
>>>>>>> 2aba719 (init project, add docker-compose, connect posgresql database)
